  ...
  return (
    ...
    <HomePageLayout>
        <div className="min-h-[100vh] flex flex-col justify-center items-center ">
            ...
            <p className="text-xl text-center ">This subscription will give you access of all available courses on our platform for <span className=" text-orange-500">1 Year Duration</span> . All existing and new released courses will also be available.</p>
            <h1 className="text-2xl text-orange-500 text-center"><BiRupee className="inline text-2xl"/> <span>499/- only</span> </h1>
            <p className="text-center text-xl">100% refund on cancellation <br />
            <span className="text-sm"> *Terms & Conditions Apply</span>
           
            </p>
            </div>
            <button type="submit" className="py-1 text-center m-0 w-full rounded-b-lg text-2xl font-bold bg-green-500">Buy Now</button>
            </form>
