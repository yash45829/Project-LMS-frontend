...
async function courseImageHandler(e){
  e.preventDefault();
...
function onSubmit(e){
e.preventDefault();
  if(!userInput.title || !userInput.category || !userInput.description || !userInput.createdBy ){
      ...
      <div className="min-h-[100vh] flex justify-center items-center">
        ...
        <div className="grid grid-cols-2 gap-x-4 px-2 py-8 ">
          <div className="px-2 flex flex-col justify-center  gap-y-4 ">
            <div className=" my-10  ">
              <label htmlFor="image" className="  text-shadow font-semibold rounded-lg bg-gray-300 drop-shadow-sm    cursor-pointer " >
          ...
          <div className="flex flex-col w-full">
            <label htmlFor="createdBy" className="text-[16px] font-semibold">
              Instructor
            </label>
            <input
              type="text"
        ...
        <button className="text-center w-full  text-xl my-2 text-white py-1 mx-auto bg-green-500 cursor-pointer hover:bg-green-700 rounded-2xl font-semibold " type="submit">Create</button>
